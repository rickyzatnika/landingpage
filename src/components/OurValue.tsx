...
const OurValue = () => {
  return (
    <div className="w-full py-8 md:py-14 px-4 md:px-28 xl:px-32 2xl:px-44">
      <h3 className="pb-8 text-md md:text-lg  text-gray-700">
        Alasan mengapa Bekerja sama dengan kami ?
      </h3>
      <div className="flex flex-col md:flex-row gap-4 w-full">
        {values.map((value) => (
          <div
            key={value.id}
            className=" bg-white w-full shadow-md rounded-lg py-8 flex flex-col gap-2 items-center justify-center"
          >
            <div className="bg-white shadow-md p-4 rounded-full w-fit text-[#a8ca41]">
              {value.icon}
            </div>
